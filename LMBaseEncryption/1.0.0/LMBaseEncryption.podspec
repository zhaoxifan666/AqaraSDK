...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/zhaoxifan666/AqaraSDK/LMBaseEncryption"
  spec.license      = "MIT"
  spec.author       = { "zhaoxifan" => "xifan.zhao@aqara.com" }
  spec.platform     = :ios, "12.0"
  spec.source       = { :git => "https://github.com/zhaoxifan666/AqaraSDK/LMBaseEncryption", :tag => "#{spec.version}" }
